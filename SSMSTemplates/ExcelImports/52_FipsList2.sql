--DROP TABLE FipsList2


SELECT
	[FIPS Code], [Postal State], [County Name]
INTO FipsList2
FROM (VALUES
('01001', 'AL', 'AUTAUGA'),
('01003', 'AL', 'BALDWIN'),
...
('02195', 'AK', 'PETERSBURG'),
('02198', 'AK', 'PRINCE OF WALES-HYDER'),
('02220', 'AK', 'SITKA'),
('02230', 'AK', 'SKAGWAY'),
...
('56045', 'WY', 'WESTON'),
('66010', 'GU', 'GUAM'))
vdata ([FIPS Code], [Postal State], [County Name])


CREATE UNIQUE CLUSTERED INDEX [FIPS Code] ON FipsList2([FIPS Code] )