...
SELECT
    @SQL =
    CONCAT(
        'DROP TABLE IF EXISTS [dbo].[Houseamp_WA_OL_Chg_20210913_New]
...
BEGIN
	...
	COMMIT
END
CREATE UNIQUE CLUSTERED INDEX [Quantarium_Internal_PID] ON [Houseamp_WA_OL_Chg_20210913] ([Quantarium_Internal_PID]) WITH (DATA_COMPRESSION = ROW)
')
FROM [#cols] AS [c]
